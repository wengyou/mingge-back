...
const ServiceForm = axios.create({
    ...
    // baseURL: process.env.NODE_ENV === 'production' ? 'http://49.235.20.228:8080/':'http://49.235.20.228:8080/',
        baseURL: 'https://www.zxfuping.cn:8080/',
    //     baseURL: 'http://49.235.20.228:8000/',
        headers: {
            get: {
...
//请求拦截器
ServiceForm.interceptors.request.use(config => {
...
//响应拦截器
ServiceForm.interceptors.response.use(response => {
